...
export function CompanyCard({ company, onResearch, loading = false }: { company: Record<string, unknown> | null; onResearch?: () => void; loading?: boolean }) {
